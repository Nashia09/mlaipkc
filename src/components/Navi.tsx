...
{/* <!-- Topbar --> */}
  <div className="max-w-[85rem] mx-auto w-full px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-end gap-x-5 w-full py-2 sm:pt-2 sm:pb-0">
      <a className="inline-flex justify-center items-center gap-2 font-medium text-slate-600 hover:text-slate-500 text-sm dark:text-slate-400 dark:hover:text-slate-300" href="#">
      ...
      <a className="inline-flex justify-center items-center gap-2 font-medium text-slate-600 hover:text-slate-500 text-sm dark:text-slate-400 dark:hover:text-slate-300" href="#">Sign In</a>
      <a className  ="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-blue-600 text-blue-600 hover:border-blue-500 hover:text-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:border-blue-500 dark:text-blue-500 dark:hover:text-blue-400 dark:hover:border-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Apply Now</a>
    </div>
  </div>
  {/* <!-- End Topbar --> */}
    ...
    <div className="relative md:flex md:items-center md:justify-between">
      ...
      >
        ...
        className={`font-medium ${
          isActiveLink('/') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-800 hover:text-gray-600'
      ...
      <Link
        to="/About"
        className={`font-medium ${
          isActiveLink('/About') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-800 hover:text-gray-600'
        } py-3 md:py-6 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600`}
      >
        About Us
      </Link>
            ...
            <div className="hs-dropdown  [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover]  py-3 md:py-6">
              <button type="button" className="flex items-center w-full text-gray-800 hover:text-gray-600 font-medium dark:text-gray-200 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" onClick={handleDropdownToggle}>
                Resources
                ...
                <div className="grid grid-cols-2 md:grid-cols-10">
                  <div className="md:col-span-3">
                    <div className="flex flex-col py-6 px-3 md:px-6">
                      <div className="space-y-4">
                        <span className="mb-2 text-xs font-semibold uppercase text-gray-800 dark:text-gray-200">Training</span>
                        ...
                        <a className="flex gap-x-4 text-gray-800 hover:text-blue-600 dark:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                          ...
                          <div className="grow">
                            <Link to="/Instructors">Facilitators</Link>
                          </div>
                        </a>
                  ...
                  <div className="col-span-full md:col-span-4">
                    <div className="flex flex-col bg-gray-50 p-6 dark:bg-gray-700">
                      <span className="text-xs font-semibold uppercase text-gray-800 dark:text-gray-200">Recent Happenings</span>

                      <a className="mt-4 group dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                        <div className="aspect-w-16 aspect-h-9">
                          <img className="w-full h-40 object-cover rounded-lg" src="https://peacekeeping.un.org/sites/default/files/styles/1200x500/public/zoungrana_1_0.jpeg?itok=4rvPdsvx" alt="Image Description" />
                        </div>
                        <div className="mt-2">
                          <p className="text-gray-800 dark:text-gray-200">Advertisement For Articles And Advertisement For Publication In The Peacekeeper Magazine
.</p>
        ...
        to="/Blog"
        className={`font-medium ${
          isActiveLink('/Blog') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-800 hover:text-gray-600'
        } py-3 md:py-6 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600`}
      >
        News
      </Link>
