    ...
    <section className="py-6">
      ...
      <div className="text-center mb-24">
            ...
            <h1 className="font-heading text-5xl xs:text-6xl md:text-7xl font-bold">
              <span>MLAIPKC IN NUMBERS</span>
            </h1>
          </div>

        <div className="border border-gray-200 bg-orange-500 rounded-3xl flex flex-wrap mb-32">
          <div className="w-full md:w-1/2 lg:w-1/4 py-8">
            <div className="md:border-r border-gray-200 px-12">
              <p className="text-white mb-2 text-center">Founded</p>
              <h2 className="text-white text-4xl lg:text-5xl font-semibold text-center">
                2023
              </h2>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/4 py-8">
            <div className="lg:border-r border-gray-200 px-12">
              <p className="text-white mb-2 text-center">Total funding</p>
              <h2 className="text-white text-4xl lg:text-5xl font-semibold text-center">
                $9.6M
              </h2>
            </div>
          ...
          <div className="w-full md:w-1/2 lg:w-1/4 py-8">
            <div className="md:border-r border-gray-200 px-12">
              <p className="text-white mb-2 text-center">Team members</p>
              <h2 className="text-white text-4xl lg:text-5xl font-semibold text-center">
                110
              </h2>
            </div>
          ...
          <div className="w-full md:w-1/2 lg:w-1/4 py-8">
            <div className="px-12">
              <p className="text-white mb-2 text-center">Nationalities</p>
              <h2 className=" text-white text-4xl lg:text-5xl font-semibold text-center">
                24
              </h2>
            </div>
