                ...
                <button className="flex group w-full items-start justify-between text-left">
                  <div className="max-w-xl pr-5">
                    ...
                    <p className="hidden group-hover:block mt-3 text-lg text-gray-500">
                      ...
                      security in the Repulic of Congo. Outstanding success of
                      ...
                      autonomous and name Nigerian Army Peackeeping Centre on
                      January of 2009, which was in a need to solving the
                      growing requirements to ensure the Peacekeepers are more
                      humane and gives priority to protection of the rights of
                      citizens. The dynamic nature of Contemporary PSO revealed
                      some dauting challenges to the successful participation of
