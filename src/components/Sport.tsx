// src/components/SportCenter.jsx
...
const images = [
  ...
  return (
    <section ref={sectionRef} className="bg-white p-6 rounded-lg shadow-lg">
      <h2 className="text-xl font-semibold mb-4">Sport Center</h2>
...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
      ...
      <p className="text-gray-700">Our sport center includes a gym, swimming pool, and various courts for basketball, tennis, and more.</p>
    </section>
  );
};
