  ...
  />
    ...
    <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-400">© 2024 MLAIPKC. All rights reserved. Developed by <a className="text-fuchsia-400" href='mailto:nashiamamman@gmail.com'>Apex Inc.</a></p>
      </div>
