...
import mlmed from "../assets/hero/mlmed.jpg";
import ml from "../assets/hero/ml.jpg";
import m from "../assets/hero/img3.png";
import m4 from "../assets/hero/img4.jpeg";
      ...
      <div className="relative  mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
        ...
        >
          <h1 className="text-3xl text-white font-extrabold sm:text-5xl w-full">
            WELCOME TO
            <strong className="block font-extrabold white ">
              {" "}
          ...
          <TypeAnimation
            ...
            repeat={Infinity}
          />
          <p className="mt-4 max-w-lg sm:text-xl/relaxed"></p>
