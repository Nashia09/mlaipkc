...
const CourseDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    courseRepository.listCourses().then((courses) => {
      // Find the course with the matching id
      // console.log("here",courses.data)
      const selectedCourse = courses?.data.find((c) => {
        c.uid === id;
      });
                ...
                <table className="w-full mb-4 border border-orange-500">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-orange-500">
                      ...
                      <td className="py-2 border-r border-orange-500">
                        senior civilian (Director level), police (Superintendent
                        and above), military personnel (Lt Col and above) and
                        NGOs
                      </td>
                    </tr>
                    <tr className="border-b border-orange-500">
        ...
        <div className="bg-white sm:px-6 p-4 justify-start items-start text-start">
          <div className="max-w-2xl mx-auto">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-4">
                With a high spate of armed conflicts world over particularly in
                Africa, attempts at finding a lasting solution to peace,
                democracy and consequent development have stalled as a result of
                the numerous conflicts which continue to plague the African
                continent. Peacekeeping Missions and Stabilisation Operations
                are the key instruments to deal with these inter and intra state
                conflicts. To make these missions successful, an efficient
                Mission HQ with sound structures and procedures as well as
                professional military, police and civilian staff is paramount.
                Therefore, training of HQ personnel is the leverage for
                successful peace operations in the future. Specific knowledge
                and skills are the key to master all future challenges in these
                kinds of operations. The ability of civilian, police and
                military personnel to cooperate in an integrated HQ and perform
                duties in current operations and in operational planning in an
                integrated approach is the basis for successful peace
                operations.
              </p>
            </div>
            <hr className="my-10" />
            <div className="grid gap-16">
              ...
              <div>
                ...
                <div className="mt-4">
                  <p className="text-gray-500 text-sm">
                    The aim of the UNSOC is to train military, police and
                    civilian Headquarters (HQ) Staff within the West Africa Sub
                    region with the ability to man/support the ECOWAS Standby
                    Force, African Union or United Nations HQ. Staff of a
                    Mission HQ should be trained in planning and decision-making
                    process. The course also aims to establish and foster
                    regional cooperation and coordination between individuals
                    and institutions engaged in ECOWAS, AU, UN and other
                    institutional Peacekeeping Missions (PKM).
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="mt-4">
                  <ol>
                    <li>
                      The participants will understand the history and
              ...
              <div>
                ...
                <div className="mt-4">
                  <p className="text-gray-500 text-sm">
                    Set at the operational level, the course targets a mixed
                    group of middle and above leadership from the following:
                    ECOWAS Standby Forces HQ Structure officials – military,
                    police and civilians FHQ Individuals and members of ongoing
                    peacekeeping missions; Government officials, operational
                    level staffers and police; ECOWAS/AU/UN peacekeeping mission
                    military personnel directly involved in operational planning
                    and implementation of policies; Selected personnel by
                    ECOWAS, AU, and UN Member States to be deployed in a
