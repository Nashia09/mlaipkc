    ...
    <div className="relative container px-4 mx-auto">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-24">
          <span className="inline-block py-1 px-3 mb-4 text-xs font-semibold text-orange-900 bg-orange-50 rounded-full">FREQUENTLY ASKED QUESTIONS</span>
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/2 px-4 mb-6 lg:mb-0">
            <div className="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
              <button className="flex group w-full items-start justify-between text-left">
                <div className="max-w-xl pr-5">
                  <h3 className="text-xl font-semibold text-orange-900 mb-3">HOW DO I REGISTER?</h3>
                  <p className="text-lg text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus.</p>
                </div>
                <div>
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-orange-900 text-orange-50">
            ...
            <div className="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
              <button className="flex group w-full items-start justify-between text-left">
                <div className="max-w-xl pr-5">
                  ...
                  <p className="hidden group-hover:block mt-3 text-lg text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus.</p>
                </div>
                <div>
            ...
            <div className="px-8 py-10 bg-white rounded-3xl shadow-lg">
              <button className="flex group w-full items-start justify-between text-left">
                <div className="max-w-xl pr-5">
                  <h3 className="text-xl font-semibold text-black group-hover:text-orange-900">How to apply saturn to our project?</h3>
                  <p className="hidden group-hover:block mt-3 text-lg text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus.</p>
                </div>
                <div>
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-orange-50 text-orange-900 group-hover:bg-orange-900 group-hover:text-orange-50 transition duration-200">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
              <button className="flex group w-full items-start justify-between text-left">
                <div className="max-w-xl pr-5">
                  <h3 className="text-xl font-semibold text-black group-hover:text-orange-900">How was the Terms & Condition?</h3>
                  <p className="hidden group-hover:block mt-3 text-lg text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus.</p>
                </div>
                <div>
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-orange-50 text-orange-900 group-hover:bg-orange-900 group-hover:text-orange-50 transition duration-200">
            ...
            <div className="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
              <button className="flex group w-full items-start justify-between text-left">
                <div className="max-w-xl pr-5">
                  <h3 className="text-xl font-semibold text-black group-hover:text-orange-900">How much we can buy this product?</h3>
                  <p className="hidden group-hover:block mt-3 text-lg text-gray-500">Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra vivamus.</p>
                </div>
                <div>
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-orange-50 text-orange-900 group-hover:bg-orange-900 group-hover:text-orange-50 transition duration-200">
