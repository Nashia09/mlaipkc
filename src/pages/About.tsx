    ...
    <section className="py-10 lg:py-20 bg-stone-100 font-poppins dark:bg-gray-800">
      <div className="max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
        <div className="flex flex-wrap ">
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
            <div className="lg:max-w-md">
              ...
              <p className="px-4 mb-10 text-base leading-7 text-gray-500 dark:text-gray-400">
                ...
                the Nigerian Armed force towards keeping peace around the world.
              </p>
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <img
              src="https://web.archive.org/web/20220520050939im_/https://mlailpkc.org.ng/static/images/about/about1.jpg"
              alt=""
